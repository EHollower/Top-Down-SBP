...
\begin{frame}
    ...
    \begin{center}
        \small
        \textbf{Paper:} Ammar, O., Wolfe, C., \& Chaudhari, P. (2025)\\
...
\begin{frame}{Experimental Setup}
    \begin{block}{Hardware Configuration}
        \begin{itemize}
            \item \textbf{CPU:} AMD Ryzen 9 7845HX (12 cores, 24 threads)
            \item \textbf{RAM:} 64GB DDR5
            \item \textbf{Compiler:} GCC 14.2 with -O3 -march=native
            \item \textbf{OS:} Ubuntu 24.04 LTS
            \item \textbf{Parallelization:} OpenMP 5.0
        \end{itemize}
    \end{block}
        ...
        \begin{block}{Our Sequential Results}
            \begin{center}
                \begin{tabular}{ccc}
                    ...
                    500 & 0.039s & 13.0× \\
                    1000 & 0.203s & 16.6× \\
                    \alert{8000} & \alert{NA} & \alert{52.0×} \\
                    \bottomrule
                \end{tabular}
            \end{center}
            \vspace{0.1cm}
...
\begin{frame}{References \& Questions}
    \begin{block}{Paper}
        \small
        Ammar, O., Wolfe, C., \& Chaudhari, P. (2025). \textit{Top-Down Stochastic Block Partitioning.} HPDC '25.\\
        \vspace{0.1cm}
